...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Void> handleAsyncRequestTimeoutException(AsyncRequestTimeoutException ex) {
        // Intercepts the onTimeout/onCompletion behaviors for SSE to complete the emitter 
        // effectively clearing server thread pools and bypassing browser connection limits.
